...
public class MenuStateStageSelect extends BasicGameState {
    ...
    private void Initialize() throws SlickException {
       ...
       // Images.AddImage("Resource/Image/Menu/Background/Temp-MainMenuBackground.png", 0f, 0f, true);
        ...
        Text.AddText("Where should I go?", 0, 56, 1);
        Text.CenterTextLast();
        ...
        MenuOptions = new MenuOptionManager(1, 3);
        MenuOptions.NewOptionButton(0, 0, "House", 1, 48, 412);
        MenuOptions.AddTextToOption(0, 0, "Nearby Houses", 80, 412, Color.white);
        MenuOptions.ShowLastText(0, 0, "Always");
                
        MenuOptions.NewOptionButton(0, 1, "Basement", 2, 300, 412);
        MenuOptions.AddTextToOption(0, 1, "Hospital Basement", 332, 412, Color.white);
        MenuOptions.ShowLastText(0, 1, "Always");
        
        MenuOptions.NewOptionButton(0, 2, "Morgue", 3, 48, 372);
        MenuOptions.AddTextToOption(0, 2, "Hospital Morgue", 80, 372, Color.white);
        MenuOptions.ShowLastText(0, 2, "Always");
    ...
    public void keyPressed(int key, char c) 
    {
        ...
        } else if (key == Keyboard.Player1Pause)
        {
            ...
            if (activation.equals("House"))
            {
                main.Global.CurrentLevel = 2;
                main.Global.SetupState = Global.LevelSetupState.New;
                SwapState(LevelState.ID);
            } else if (activation.equals("Basement")) {
                main.Global.CurrentLevel = 3;
                main.Global.SetupState = Global.LevelSetupState.New;
                SwapState(LevelState.ID);
            } else if (activation.equals("Morgue")) {
                main.Global.CurrentLevel = 4;
                main.Global.SetupState = Global.LevelSetupState.New;
                SwapState(LevelState.ID);
            }
        }
