 ...
 * @author McRib
 */
public class Level2DeskDrawer extends GameObject {
            
    public Level2DeskDrawer(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// </editor-fold>
    ...
    public void ProcessCollision(GameObject Object)
    {
        ...
        {
            if (main.Global.SwitchVariables.GetVariable("DrawerKey")) {
                //We got the thing!
                main.Global.SwitchVariables.SetVariable("SecurityClearanceKey", true);
                LevelState.OpenChatWindow("Level2-OpenDrawer");
                IsAlive = false;
            } else {
                LevelState.OpenChatWindow("Level2-LockedDrawer");
            }
        }
    }
}