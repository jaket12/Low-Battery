 ...
 * @author McRib
 */
public class Level1Door extends GameObject {
        
    private float SundownPercent;
    
    public Level1Door(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
    ...
    public void ProcessCollision(GameObject Object)
    {
        if (Object.GetIsAlive() && Objects.equals(Object.GetName(), "Player Activator"))
        {
            ...
            if (SundownPercent == 100) {
                //Fresh day, good to go hunting
                LevelState.PerformCutScene("Resource/Movie/Level1-BeginFullDay.scr", Global.CutSceneType.CustomEvent);
            } else if (SundownPercent >  50) {
                //Day is a little over. Best return soon.
                LevelState.PerformCutScene("Resource/Movie/Level1-BeginPartialDay.scr", Global.CutSceneType.CustomEvent);
            } else if (SundownPercent <= 50) {
                //Day is pretty much over. Best to wait until tomorrow.
                LevelState.OpenChatWindow("Level1-WarnLateDay");
            }
