 ...
 * @author McRib
 */
public class Level4DoorToLevel5 extends GameObject {
            
    public Level4DoorToLevel5(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// </editor-fold>
    ...
    public void ProcessCollision(GameObject Object)
    {
        ...
        {
            if (main.Global.SwitchVariables.GetVariable("DoorPasscode")) {
                //We got the thing!
                LevelState.PerformCutScene("Resource/Movie/Level4-EnterLevel5.scr", Global.CutSceneType.CustomEvent);
            } else {
                //We don't have the thing. Tell him to get the thing!
                LevelState.OpenChatWindow("Level4-NeedDoorPasscode");
            }
        }
    }
}