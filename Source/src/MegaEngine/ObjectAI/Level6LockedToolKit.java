 ...
 * @author McRib
 */
public class Level6LockedToolKit extends GameObject {
            
    public Level6LockedToolKit(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// <editor-fold defaultstate="collapsed" desc="Animation0 Default">
        ...
        EntityAnimation[0].AddFrame(0, 15, 5000, 0, 0);
...
// </editor-fold>
    ...
    protected void ComputeStatus(int delta, int[][][] TileData, int[][] RoomData, PlayerCharacter Player) {
        ...
        if (main.Global.SwitchVariables.GetVariable("ToolKit")) {
            IsAlive = false;
        }
    }
    ...
    public void ProcessCollision(GameObject Object)
    {
        ...
        {
            if (main.Global.SwitchVariables.GetVariable("JanitorKeyRing")) {
                //We got the thing!
                main.Global.SwitchVariables.SetVariable("ToolKit", true);
                LevelState.OpenChatWindow("Level6-OpenLockedToolKit");
                IsAlive = false;
            } else {
                LevelState.OpenChatWindow("Level6-LockedToolKit");
            }
        }
    }
}