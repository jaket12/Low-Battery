...
public class Level1LifeSupport extends GameObject {
            
    public Level1LifeSupport(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// <editor-fold defaultstate="collapsed" desc="Basic Setup">
        ...
        //Stats and Values
        Name = "Level 1 Life Support System";
        OwnerName = "None";
        IsPlayerOwned = false;
        OwnerArrayIndex = -1;
        EntityArrayIndex = -1;
    ...
    public void ProcessCollision(GameObject Object)
    {
        if (Object.GetIsAlive() && Objects.equals(Object.GetName(), "Player Activator"))
        {
            if (main.Global.SwitchVariables.GetVariable("SpareBattery")) {
                //We got the thing! End the game.
                LevelState.PerformCutScene("Resource/Movie/Level1-EndGame.scr", Global.CutSceneType.CustomEvent);
            } else {
                //We don't have the thing. Tell him to get the thing!
                LevelState.OpenChatWindow("Level1-Monitor");
            }
