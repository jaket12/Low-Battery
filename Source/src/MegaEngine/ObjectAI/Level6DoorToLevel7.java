 ...
 * @author McRib
 */
public class Level6DoorToLevel7 extends GameObject {
            
    public Level6DoorToLevel7(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// </editor-fold>
    ...
    public void ProcessCollision(GameObject Object)
    {
        ...
        {
            LevelState.PerformCutScene("Resource/Movie/Level6-EnterLevel7.scr", Global.CutSceneType.CustomEvent);
        }
    }
}