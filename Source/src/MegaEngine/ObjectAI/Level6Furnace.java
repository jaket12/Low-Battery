 ...
 * @author McRib
 */
public class Level6Furnace extends GameObject {
            
    public Level6Furnace(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// </editor-fold>
    ...
    public void ProcessCollision(GameObject Object)
    {
        ...
        {
            if (main.Global.SwitchVariables.GetVariable("FrozenJanitorKeyRing")) {
                //We got the thing!
                main.Global.SwitchVariables.SetVariable("JanitorKeyRing", true);
                LevelState.OpenChatWindow("Level6-UseFurnace");
                IsAlive = false;
            } else {
                LevelState.OpenChatWindow("Level6-InspectFurnace");
            }
        }
    }
}