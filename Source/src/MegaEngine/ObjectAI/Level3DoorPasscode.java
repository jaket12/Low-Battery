 ...
 * @author McRib
 */
public class Level3DoorPasscode extends GameObject {
            
    public Level3DoorPasscode(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// <editor-fold defaultstate="collapsed" desc="Animation0 Default">
        ...
        EntityAnimation[0].AddFrame(0, 14, 5000, 0, 0);
...
// </editor-fold>
    ...
    public void ProcessCollision(GameObject Object)
    {
        ...
        {
            main.Global.SwitchVariables.SetVariable("DoorPasscode", true);
            LevelState.OpenChatWindow("Level3-DoorPasscode");
            IsAlive = false;
        }
    }
}