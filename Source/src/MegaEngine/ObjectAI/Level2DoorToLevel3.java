 ...
 * @author McRib
 */
public class Level2DoorToLevel3 extends GameObject {
            
    public Level2DoorToLevel3(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// </editor-fold>
    ...
    public void ProcessCollision(GameObject Object)
    {
        ...
        {
            LevelState.PerformCutScene("Resource/Movie/Level2-EnterLevel3.scr", Global.CutSceneType.CustomEvent);
        }
    }
}
