...
public class Level3DoorToLevel2 extends GameObject {
            
    public Level3DoorToLevel2(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// </editor-fold>
    ...
    public void ProcessCollision(GameObject Object)
    {
        ...
        {
            LevelState.PerformCutScene("Resource/Movie/Level3-EnterLevel2.scr", Global.CutSceneType.CustomEvent);
        }
    }
}