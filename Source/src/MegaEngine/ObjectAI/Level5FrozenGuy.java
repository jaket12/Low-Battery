 ...
 * @author McRib
 */
public class Level5FrozenGuy extends GameObject {
            
    public Level5FrozenGuy(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// <editor-fold defaultstate="collapsed" desc="Animation0 Default">
        ...
        EntityAnimation[0].AddFrame(0, 13, 5000, 0, 0);
...
// </editor-fold>
    ...
    public void ProcessCollision(GameObject Object)
    {
        ...
        {
            main.Global.SwitchVariables.SetVariable("FrozenJanitorKeyRing", true);
            LevelState.OpenChatWindow("Level5-FrozenGuy");
            IsAlive = false;
        }
    }
}