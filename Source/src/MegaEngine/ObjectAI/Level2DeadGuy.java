 ...
 * @author McRib
 */
public class Level2DeadGuy extends GameObject {
            
    public Level2DeadGuy(int aitype, Global.Directions horzfacing, Global.Directions vertfacing, float locationx, float locationy, boolean solidwall, boolean deleteonactivate, int objectarrayid, float spriterow, float spritecolumn, String cutscenefilename)
    {
...
// <editor-fold defaultstate="collapsed" desc="Animation0 Default">
        ...
        EntityAnimation[0].AddFrame(0, 12, 5000, 0, 0);
...
// </editor-fold>
    ...
    public void ProcessCollision(GameObject Object)
    {
        ...
        {
            main.Global.SwitchVariables.SetVariable("DrawerKey", true);
            LevelState.OpenChatWindow("Level2-DeadGuy");
            IsAlive = false;
        }
    }
}