 ...
 * @author McRib
 */
public class MenuStateGameOverDeath extends BasicGameState {
    ...
    private void Initialize() throws SlickException {
        ...
        Text.AddText("I tried to save you,", 0, 200, 1);
        Text.CenterTextLast();
        Text.AddText("But I couldn't even save myself.", 0, 248, 1);
        Text.CenterTextLast();
        Text.AddText("I am so sorry...", 0, 296, 1);
        Text.CenterTextLast();
